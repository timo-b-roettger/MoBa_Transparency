...
data_original <- read_csv("../data/Reproducible research practices and transparency in secondary data analysis - MoBa.csv")
coder_assignment <- read_csv("../data/test_coding_assignment.csv")
OA_original <- read_csv("../data/2024-03-23_MoBaTransparency-OAAssessment.csv")
...
# so all in all no need for further cross-coding
...
# load in
consensus <- read_csv("../data/MoBa_Consensus4Import.csv")
